...
import Transferir from "./pages/Operaciones/Transferir";
import DetallesBilletera from "./pages/DeatllesBilletera";
  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/transferir/:id_billetera_origen" element={<Transferir />} />
        <Route path="/detalles/:id_billetera" element={<DetallesBilletera />} />
